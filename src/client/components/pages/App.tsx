...
const App: FC<AppProps> & { getInitialProps(appContext: AppContext): Promise<AppInitialProps> } = ({
    ...
    return (
        <ThemeProvider>
            <FullscreenProvider>
                {recipient && label ? (
                    <ConnectionProvider endpoint={MAINNET_ENDPOINT/*DEVNET_ENDPOINT*/}>
                        ...
                        <div className={css.logoContainer}>
                            ...
                            <form 
                                onSubmit={(e) => {
                                    ...
                                    if (address) {
                                        window.location.href = `/new?recipient=${address}&label=Solana+Summer`;
                                    }
                                }} 
                                className={css.form}
                            >
                                <input 
                                    ...
                                    className={`${css.input} ${css.inputEnhanced}`}
                                />
                                <button 
                                    type="submit" 
                                    className={`${css.button} ${css.buttonEnhanced}`}
                                >
                                    Confirm
                                </button>
                            </form>
